	...
	<div class="container">
		...
		<div class="login-content">
			<form action="BuyerLogin.php" method="post">
            	...
            	<label id="forgotPassword"  class="text-left"><a id='link' href="BuyerForgotPassword.php"><b style="color:black ;text-align:left"> Forgot your password </b></a></label>
            	<input type="submit" class="btn" name="login" value="Login">
				<label id="account" class="text-left"><a id='link' href="BuyerRegistration.php"><b style="color:black"> Create New Account</b></a></label>
            </form>
        </div>
    </div>
	<script>
