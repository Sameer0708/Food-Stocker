      ...
      <body>
                ...
                <div class=" flex-row-reverse left ">
                    ...
                    <a href="CartPage.php"> <i class="fa" style=" color:green ;font-size:20px;margin-top:-20px;margin-bottom:20px;">&#61562;</i></a> -->
                     ...
                     <a class="float-left" href="#">
                          <img src="agro.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:100px;">
                     </a>
                </div>
        ...
        <script>
           ...
           <div class="row" style="text-align:center;">
                ...
                <div class="col-md-3 col-sm-12">
                     <a href="CallCenter.php" id="navbar"><i class="fa-solid fa-phone" style="color: #1c9504;"></i><label>Call Centers/SMS</label></a>
                </div>
           </div>
           <hr>
           ...
           <div class="features container">
                ...
                <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap;">
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold cursor:pointer;">Sms System </h4>
                               <br>
                     ...
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold cursor:pointer;">Buyer Connection</h4>
                               <br>
                     ...
                     <div class="card">
                          ...
                          <div class="card-body">
                               <h4 class="card-title font-weight-bold cursor:pointer;">Farmer Group Formation</h4>
                               <br>
